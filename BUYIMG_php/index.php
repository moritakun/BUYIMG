			...
			jQuery(function($) {//top背景画像の切り替え
			    $('.center').bgSwitcher({
			        images: ['./img/common/center_1.jpg','./img/common/center_2.jpg','./img/common/center_3.jpg',
											...
											'./img/common/center_10.jpg','./img/common/center_11.jpg','./img/common/center_12.jpg',
											'./img/common/center_13.jpg','./img/common/center_14.jpg','./img/common/center_15.jpg',
											'./img/common/center_16.jpg','./img/common/center_17.jpg','./img/common/center_18.jpg',
											'./img/common/center_19.jpg','./img/common/center_20.jpg'],
							interval: 3000,
			        loop: true,
			        shuffle: true,
			        effect: "fade",
