...
<html>
  ...
  <body>
    <?php
      ...
      {
        $sql=" select * from product_master where product_name like'%{$_POST["seaech_word"]}' OR product_introduction like'%{$_POST["seaech_word"]}' OR big_category like'%{$_POST["seaech_word"]}' OR author_name like'%{$_POST["seaech_word"]}'";
      }
      else
      {
        $sql=" select * from product_master where big_category='{$_POST["big_category"]}'";
      }
